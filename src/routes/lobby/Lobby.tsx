  ...
  return (
    ...
    className="container d-flex flex-column justify-content-center align-items-center min-vh-100">
      ...
      >
        ...
        <h4 className="text-center mb-4">Host: {host}</h4>

        <div className="row mb-2">
          <div className="col-6">
            <h4 className="text-center">Red Team</h4>
            <ul>
              {redTeam.map(name => renderPlayer(name))}
            </ul>
          </div>
          <div className="col-6">
            <h4 className="text-center">Black Team</h4>
            <ul>
              {blackTeam.map(name => renderPlayer(name))}
            </ul>
          </div>
        </div>
        ...
        <div className="d-flex justify-content-between mt-5">
          ...
          <button className="btn btn-outline-success w-48" 
            ...
            {playerName === host ? "Start Game" : "Ask Host to Start!"}
          </button>
        </div>
      </div>
    </div>
